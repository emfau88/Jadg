...
const winterAnimalTypes = [
    { name: 'duck',       image: 'duck',      speed: 1.0, score: 120, health: 1, scale: 0.84, type: 'flying', sound: 'duck'   },
    { name: 'rehbock',    image: 'rehbock',   speed: 0.85, score: 200, health: 1, scale: 1.1,  type: 'ground', sound: 'deer'   },
    { name: 'hog',        image: 'hog',       speed: 0.65, score: 175, health: 1, scale: 1.0,  type: 'ground', sound: 'hog'    },
    { name: 'winterhog',  image: 'winterhog', speed: 0.55, score: 300, health: 2, scale: 1.25, type: 'ground', sound: 'hog'    }
];
...
class Boss {
    constructor() {
        ...
        // Phase 1: HP 8-5  Phase 2 (Raserei): HP 4-1
        this.phase = 1;
        ...
        // Unverwundbarkeit nach Treffer (in Frames, 60fps → 90 = 1.5 Sek)
        this.invTimer    = 0;
        this.INV_FRAMES  = 90;
    ...
    update() {
        ...
        if (this.health <= 4 && this.phase === 1) {
            ...
            playSound('kamikaze');
            standShake = 18;
            // kurze Unverwundbarkeit beim Phasenwechsel (Stagger)
            this.invTimer = 60;
        }
    ...
    draw() {
        ...
        const hpColor = hpRatio > 0.6 ? '#0f0' : hpRatio > 0.3 ? '#FFA500' : '#e74c3c';
    ...
    hit() {
        if (this.isInvulnerable) {
            // Visuelles Feedback: Schuss prallt ab
        ...
        this.health--;
        this.hitFlash  = 10;
        this.invTimer  = this.INV_FRAMES; // Unverwundbarkeit nach Treffer
        playSound('hit');
        standShake = 5;
        ...
        if (this.health <= 0) {
            ...
            // HP-Schwellen-Reaktion bei 6, 4, 2 HP
            const msg = this.health === 6 ? '😤 Grr!' :
                        this.health === 4 ? '😡 RASEREI!' :
                        this.health === 2 ? '🔥 LETZTER STAND!' : 'Treffer!';
